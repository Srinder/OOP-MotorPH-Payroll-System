...
public class ITStaff extends Employee {
    ...
    //default constructor
    public ITStaff(int employeeNumber, String lastName, String firstName, String email) {
        super(employeeNumber, lastName, firstName, email);
    }
    
    // Used by the EmployeeRepository to load full payroll details
    public ITStaff(int employeeNumber, String lastName, String firstName, String birthday, 
