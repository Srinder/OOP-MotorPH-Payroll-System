...
public class HRStaff extends Employee {
    ...
    //default constructor
    public HRStaff(int employeeNumber, String lastName, String firstName, String email) {
        super(employeeNumber, lastName, firstName, email);
    }
    
    // Used by the EmployeeRepository to load full payroll details
    public HRStaff(int employeeNumber, String lastName, String firstName, String birthday, 
